module skin {
	...
	export class CardUtil {
    	...
    	public static getPromptCards(lastCardNos:number[],cardNos:number[]):any
    	{
        	var lastCard:any = CardUtil.checkCards(lastCardNos);
...
//            game.LogUtil.log("promptArr:" + promptArr + " bombs:" + bombs);
    	 ...
    	 *  获得提示所需的基础牌，不包含所带的牌
    	 */ 
    	public static getPromptBaseCards(lastCard:any,cardNos:number[]):any
    	{
            ...
            var cardValues:number[] = cardInfo['values'];//卡牌对应的值
        ...
        public static getSimplePrompt(minVal,cardNums,valNos,promptArr,size)
        {
            var promptNos = [];
    	 ...
    	 */ 
    	public static getSimplePrompt_old(minVal,cardNums,valNos,promptArr,size)
    	{
            for(var _val in cardNums)
            {
    	 ...
    	 * size 1为单顺 2为双顺 3为三顺
    	 */ 
    	public static getStraightPrompt(minVal,num,cardNums,valNos,promptArr,size)
    	{
    	...
    	public static checkPlayCards(lastCardNos:number[],currCardNos:number[])
    	{
...
//            game.LogUtil.error("lastCard:"+lastCard);
    	...
    	public static checkCards(currCardNos:number[]):any
    	{
...
//            game.LogUtil.log("more:" + moreCardNos + " cards:" + currCardNos);
        ...
        * 校验多余卡牌
        */
    	public static checkMoreCards(cnt:number,moreCardNos:number[])
    	{
    	    if(cnt == 0||cnt == 2)
    	    {
                return true;
    	 ...
    	 * with 0不带 1单带 2双带
    	 */ 
        public static getCardsData(currCardNos: number[]):any {
    	...
    	//cardValues判断是否存在
        public static getStraight(currCardNos: number[],maxSameVal: number,cardValues: number[],straightNum: number,cardNums:number[]): any
    	 {
            var cardNos = [];
            var num = 0;
        ...
        public static cardNosToNums(currCardNos:number[]):number[]
        {
